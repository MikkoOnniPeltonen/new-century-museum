...
const SOURCES = {
  portraits: {
    ...
    files: {
      ...
      'maria-merian': 'Maria_Sibylla_Merian.jpg',
      'ibrahim-muteferrika': 'Ibrahim_Muteferrika.jpg',
      'olaudah-equiano': 'Olaudah_Equiano.png',
  ...
  works: {
    ...
    files: {
      ...
      'maria-merian': 'Merian_Metamorphosis.jpg',
      'ibrahim-muteferrika': 'Ibrahim_Muteferrika_press.jpg',
      'olaudah-equiano': 'Equiano_Interesting_Narrative.jpg',
